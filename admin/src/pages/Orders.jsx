...
const Orders = () => {
  ...
  const dueOrders = orders.filter(order =>
    orderUpdates[order._id]?.payment === 'NOT_PAID' ||
    (!orderUpdates[order._id]?.payment && order.payment === 'NOT_PAID')
  );

  const paidOrders = orders.filter(order =>
    orderUpdates[order._id]?.payment === 'PAID' ||
    (!orderUpdates[order._id]?.payment && order.payment === 'PAID')
  );
